...
let arrayOfReturns = [
  ...
  ['Your correct! ', ' is correct!', 'Your guess of ',' was too low!! ', 'You have ',' guesses left', 'Your guess of ',' was too high!! You have ',' guesses left', 'Please enter a number between 1 and 10 You have ',' guesses left'],
...
function q6() {
  for (i = 0; i < 4; i++) {
    ...
    if (guessing === arrayOfAnswers[2][0]) {
      ...
      alert(arrayOfReturns[5][2] + guessing + arrayOfReturns[5][3] + arrayOfReturns[5][4] + q6GuessLeft + arrayOfReturns[5][5]);
    }
    else if (guessing >= arrayOfAnswers[2][0]) {
      alert(arrayOfReturns[5][6] + guessing + arrayOfReturns[5][7] +q6GuessLeft + arrayOfReturns[5][8]);
    }
    else { // In case the user does not insert a number
      alert(arrayOfReturns[5][9] + q6GuessLeft + arrayOfReturns[5][10]);
    }
  }
  ...
  for (let o = 1; o <= 6; o++) { // Running 6 times for 6 total guesses
    ...
    for (let f = 0; f < arrayOfAnswers[3].length; f++) { // Loops through the array to compare answers with array
      ...
      if (guessing === arrayOfAnswers[3][f]) {
        ...
        alert(arrayOfReturns[6][0] + guessing + arrayOfReturns[6][1]);
        break; // Saves 0.000000001 seconds
      }
    }
    //If question is false, if will run, once correct, will not run
    if (!correctGuess){
      alert(arrayOfReturns[6][2] + guessing + arrayOfReturns[6][3] + q7GuessLeft + arrayOfReturns[6][4]);
    }
  }
