...
function sum(a, b) { //eslint-disable-line
  let added = a + b;
  let message = `The sum of ${a} and ${b} is ${added}.`;
...
function multiply(a, b) { //eslint-disable-line
  let added = a * b;
  let message = `The product of ${a} and ${b} is ${added}.`;
  return [added ,message];
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  // console.log(addedSum2, multiSum2 ,sumMessage, multiMessage);
...
function sumArray(sumArr) { //eslint-disable-line
  let addedSum = sum(testArray[0], testArray[1])[0];
  let addedSum2 = sum(addedSum, testArray[2])[0];
  // console.log(addedSum);
  // console.log(addedSum2);
  let message4 = `${testArray} was passed in as an array of numbers, and ${addedSum2} is their sum.`;
  return [addedSum2, message4];
}
